...
def lunge_detect(results, score, status, image):
    ...
    if results.pose_landmarks:
        ...
        cv2.putText(image, f"Left Knee Angle: {left_knee_angle:.2f}", (10, 50), FONT, 1, (0, 255, 0), 2, cv2.LINE_AA)
        cv2.putText(image, f"Right Knee Angle: {right_knee_angle:.2f}", (10, 100), FONT, 1, (0, 255, 0), 2, cv2.LINE_AA)
