...
def squat_detect(results, score, status, image):
    ...
    if results.pose_landmarks:
        ...
        cv2.putText(image, f"Right knee angle: {right_knee_angle:.2f}", (10, 30), FONT_FAMILY, FONT_SIZE, FONT_COLOR, FONT_THICKNESS, cv2.LINE_AA)
        cv2.putText(image, f"Left knee angle: {left_knee_angle:.2f}", (10, 60), FONT_FAMILY, FONT_SIZE, FONT_COLOR, FONT_THICKNESS, cv2.LINE_AA)
